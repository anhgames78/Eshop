...
},{"emitter":1,"reduce":161}],163:[function(require,module,exports){
'use strict';
...
var countries = _countries2.default.countries;

var currencyFormat = '$0,0.00';
var tax = 0.05;

window.shoppingCart = null;
window.shoppingCartKey = 'shoppingCartData3';
...
var Cart = (function (_Component) {
	...
	_createClass(Cart, [{
		...
		key: 'retrievedPosition',
		value: function retrievedPosition(position) {
			var _this2 = this;
			...
			_superagent2.default.get(geocodeURL).end(function (err, response) {
		...
		value: function updateItemQuantity(event) {
			var index = parseInt(event.target.getAttribute('data-index'));
		...
		key: 'saveCurrentItems',
		value: function saveCurrentItems() {
		...
		value: function checkout() {
			...
			var StripeHandler = StripeCheckout.configure({
				...
				token: function token(_token) {
					_token.shoppingCart = _this3.state.items;

					console.log(_token);

					$.post('/checkout', _token, function (response) {
		...
		key: 'renderCartItem',
		value: function renderCartItem(item, index) {
			var itemKey = "cart-item-" + index;

			return _react2.default.createElement(
				'div',
				{ className: 'row shopping-cart-item', key: itemKey },
				...
				_react2.default.createElement(
					'div',
					{ className: 'shopping-cart-item-description' },
					_react2.default.createElement(
						'div',
					...
					_react2.default.createElement(
						...
						(0, _numeral2.default)(item.price).format(currencyFormat),
						' x '
					),
					_react2.default.createElement(
						'div',
						{ className: 'quantity-box' },
						_react2.default.createElement('input', { type: 'number', className: 'form-control', min: 1, value: item.quantity, 'data-index': index, onChange: this.updateItemQuantity.bind(this) })
					),
					_react2.default.createElement('div', { className: 'clear-button', onClick: this.removeItem.bind(this), 'data-index': index })
				)
			);
		}
	}, {
		key: 'renderCountryOption',
		value: function renderCountryOption(country, index) {
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							(0, _numeral2.default)(this.state.subTotal).format(currencyFormat)
						)
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'div',
							{ className: 'checkout-value' },
							(0, _numeral2.default)(this.state.taxAmount).format(currencyFormat)
						)
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'div',
							{ className: 'checkout-value' },
							(0, _numeral2.default)(this.state.total).format(currencyFormat)
						)
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('input', { className: 'form-control', 'data-key': 'name', value: this.state.name, placeholder: 'Name', onChange: this.inputChanged.bind(this) })
						),
						_react2.default.createElement(
							'div',
							{ className: 'form-group' },
							_react2.default.createElement('input', { className: 'form-control', 'data-key': 'address', value: this.state.address, placeholder: 'Address', onChange: this.inputChanged.bind(this) })
						),
						_react2.default.createElement(
							'div',
							{ className: 'form-group form-inline' },
							_react2.default.createElement('input', { className: 'form-control', 'data-key': 'postalCode', value: this.state.postalCode, placeholder: postalCodePlaceholder, onChange: this.inputChanged.bind(this) }),
							_react2.default.createElement('input', { className: 'form-control', 'data-key': 'city', value: this.state.city, placeholder: 'City', onChange: this.inputChanged.bind(this) })
						),
						_react2.default.createElement(
							'select',
							{ className: 'form-control', 'data-key': 'country', value: this.state.country, onChange: this.countryChanged.bind(this) },
							countries.map(this.renderCountryOption.bind(this))
						)
					),
					_react2.default.createElement(
						'div',
						{ className: 'btn btn-primary btn-cart', onClick: this.checkout.bind(this) },
						'Purchase'
					)
				)
			);
...
window.renderShoppingCart = function (element, options) {
	var stripePublishableKey = options.stripePublishableKey;
	var defaultCountry = options.defaultCountry;

	_reactDom2.default.render(_react2.default.createElement(Cart, { stripePublishableKey: stripePublishableKey, defaultCountry: defaultCountry }), element);
};

window.updateButton();

},{"./countries.js":164,"numeral":29,"react":160,"react-dom":31,"superagent":162}],164:[function(require,module,exports){
"use strict";
